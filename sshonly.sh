...
GitUser="fsidvpn"
wget https://raw.githubusercontent.com/${GitUser}/gaspoll/main/hanyassh.sh && chmod +x hanyassh.sh && screen -S hanyassh.sh ./hanyassh.sh
wget https://raw.githubusercontent.com/${GitUser}/gaspoll/main/websocketsshonly.sh && chmod +x websocketsshonly.sh && screen -S websocketsshonly.sh ./websocket.sh
